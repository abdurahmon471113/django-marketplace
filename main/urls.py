...
urlpatterns = [
    ...
    path("favorite/save-ajax/<int:pk>/", views.save_favorite_ad_ajax, name="save_favorite_ad_ajax"),
    path("favorite/delete-ajax/<int:pk>/", views.delete_favorite_ad_ajax, name="delete_favorite_ad_ajax"),
]
